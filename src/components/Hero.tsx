    ...
    <section className="relative min-h-screen overflow-hidden pt-20 pb-20 flex items-center">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
          <div className="inline-flex items-center px-3 py-1 rounded-full border border-white/10 bg-white/5 mb-6 animate-fade-in backdrop-blur-sm">
            <span className="text-xs font-medium font-sans text-white/80">Unified Credit Intelligence for Modern Finance</span>
          </div>
